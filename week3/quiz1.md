...
- 답: 
Merge Commit: 브랜치의 병합 과정을 명확하게 남기고 싶을 때 사용 (팀 작업)

Squash and Merge: 

커밋을 하나로 합쳐 깔끔하게 정리함
대신 세부 변경 사항 확인 어려움(개인 작업)

Rebase and Merge: 
커밋 히스토리가 직선형으로 정리, 변경 사항을 쉽게 추적 가능
하지만 충돌 위험 존재
...
- 답: 
가장 최근에 develop 브랜치에서 a1s2d3f라는 코드의 커밋이 있었음. 
...
- 답: 
revert를 사용해야 한다. reset 으로 공유 브랜치가 복구 불가능하게 수정되는 경우가 있으므로 
revert가 안전하다.
